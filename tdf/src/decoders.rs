...
{
    match tdf_id {
        1 => vec!["time","application","major","minor","revision","build_num","kv_crc","blocks","uptime","reboots","flags"],
        2 => vec!["time","voltage_mv","current_ua","soc"],
        3 => vec!["time","temperature","pressure","humidity"],
        4 => vec!["time","temperature"],
        5 => vec!["time","source","shift"],
        6 => vec!["time","reason","hardware_flags","count","uptime","param_1","param_2","thread"],
        10 => vec!["time","x","y","z"],
        11 => vec!["time","x","y","z"],
        12 => vec!["time","x","y","z"],
        13 => vec!["time","x","y","z"],
        ...
        21 => vec!["time","mcc","mnc","eci","tac","earfcn","status","tech","rsrp","rsrq"],
